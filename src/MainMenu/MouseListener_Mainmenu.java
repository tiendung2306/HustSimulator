    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (Main.topGameState().equals(Main.states[0])) {
            ...
            if ((x_click > 10 * Main.ex) && (y_click > 10 * Main.ey) && (x_click < 50 * Main.ex)
                    && (y_click < 50 * Main.ey))
                Main.popGameState();
            else if (((x_click > 555 * Main.ex) && (y_click > 202 * Main.ey) && (x_click < 572 * Main.ex) && (y_click < 226 * Main.ey)) ||
                    ((x_click > 286 * Main.ex) && (y_click > 202 * Main.ey) && (x_click < 303 * Main.ex) && (y_click < 228 * Main.ey))){
                if (VideoSetting.fullscreenstr.equals("WINDOW"))
                    VideoSetting.fullscreenstr = "FULLSCREEN";
                else VideoSetting.fullscreenstr = "WINDOW";
                if (VideoSetting.fullscreenstrX == 358) VideoSetting.fullscreenstrX = 316;
                else VideoSetting.fullscreenstrX = 358;
            } else if ((x_click > 417 * Main.ex) && (y_click > 391 * Main.ey) && (x_click < 448 * Main.ex) && (y_click < 411 * Main.ey)) {
                if (!VideoSetting.checkResolution) {
                    VideoSetting.x2560x1440 = "2560 x 1440"; VideoSetting.x1920x1080 = "1920 x 1080"; VideoSetting.x1280x720 = "1280 x 720";
                    VideoSetting.x1024x768 = "1024 x 768"; VideoSetting.x768x576 = "768 x 576"; VideoSetting.x1536x1152 = "1536 x 1152";
                    VideoSetting.checkResolution = true;
                }
                else {
                    VideoSetting.x2560x1440 = ""; VideoSetting.x1920x1080 = ""; VideoSetting.x1280x720 = "";
                    VideoSetting.x1024x768 = ""; VideoSetting.x768x576 = ""; VideoSetting.x1536x1152 = "";
...
//                    DisplayMode newMode = new DisplayMode(GamePanel.screenWidth,GamePanel.screenHeight,oldMode.getBitDepth(),oldMode.getRefreshRate());
...
//                    Main.window.setLocationRelativeTo(null);
//                    Main.ex = (double) GamePanel.screenWidth/768; Main.ey = (double) GamePanel.screenHeight/576;
//                }
            }
            if (VideoSetting.checkResolution){
                if ((x_click > 225 * Main.ex) && (y_click > 423 * Main.ey) && (x_click < 370 * Main.ex) && (y_click < 448 * Main.ey)) {
                    ...
                    VideoSetting.checkResolution = false;
                } else if ((x_click > 257 * Main.ex) && (y_click > 463 * Main.ey) && (x_click < 383 * Main.ex) && (y_click < 488 * Main.ey)) {
                    ...
                    VideoSetting.checkResolution = false;
                } else if ((x_click > 256 * Main.ex) && (y_click > 504 * Main.ey) && (x_click < 398 * Main.ex) && (y_click < 530 * Main.ey)) {
                    ...
                    VideoSetting.checkResolution = false;
                } else if ((x_click > 482 * Main.ex) && (y_click > 423 * Main.ey) && (x_click < 610 * Main.ex) && (y_click < 448 * Main.ey)) {
                    ...
                    VideoSetting.checkResolution = false;
                } else if ((x_click > 481 * Main.ex) && (y_click > 464 * Main.ey) && (x_click < 622 * Main.ex) && (y_click < 488 * Main.ey)) {
                    ...
                    VideoSetting.checkResolution = false;
                } else if ((x_click > 482 * Main.ex) && (y_click > 504 * Main.ey) && (x_click < 623 * Main.ex) && (y_click < 528 * Main.ey)) {
