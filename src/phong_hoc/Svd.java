...
public class Svd extends Map {
    ...
    public void draw(Graphics2D g2) {
        g2.drawImage(tileManager.tile[36].image,0,119*gp.scale,256*gp.scale,73*gp.scale,null);
        g2.drawImage(tileManager.tile[35].image,0,0,209*gp.scale,55*gp.scale,null);
        g2.drawImage(tileManager.tile[37].image,139*gp.scale,0,117*gp.scale,87*gp.scale,null);
        g2.drawImage(tileManager.tile[20].image,0,55*gp.scale,174*gp.scale,40*gp.scale,null);
        g2.drawImage(tileManager.tile[17].image,0,45*gp.scale,174*gp.scale,10*gp.scale,null);
        ...
        g2.drawImage(tileManager.tile[40].image,0,95*gp.scale,256*gp.scale,32*gp.scale,null);
