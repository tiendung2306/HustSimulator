...
public class C2_hall extends Map {
    ...
    private void TileLoad() {
        ...
        try {
            ...
            layer1 = new Tile(new Rectangle(0, 0, layer1_img.getWidth(), layer1_img.getHeight()), "layer1", "", null,
                    layer1_img);
            BufferedImage layer2_img = ImageIO.read(new FileInputStream("res/tile/C2_hall_layer (2).png"));
            layer2 = new Tile(new Rectangle(0, 0, layer2_img.getWidth(), layer2_img.getHeight()), "layer2", "", null,
                    layer2_img);
