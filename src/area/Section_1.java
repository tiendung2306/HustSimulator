...
public class Section_1 extends Map {
    ...
    private void TileLoad() {
        ...
        // Rectangle[] tmp1 = {new Rectangle(32,1757,795,165),new Rectangle(172,1649,690,111),new Rectangle(12,1624,161,151)};
        // Rectangle[] tmp2 = {new Rectangle(537,2037,167,39),new Rectangle(31,2036,141,8),new Rectangle(30,2019,794,20),new Rectangle(30,1920,797,101)};
        // Object tmp = new Object(this, "C9", "C9", new Rectangle(9, 1619, 855, 462), tmp1, tmp2);
        // addObject(tmp);
    }
