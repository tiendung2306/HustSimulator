...
public class ComputerRoom extends Map {
    ...
    public void setDefaultValues() {
        ...
        tileComputerTeacher = new Tile(gamePanel, 274, 182, 28, 28, "Teacher Computer", "Interact", "",
                "res/tile/may_tinh_gv.png", 1);
    ...
    private void setUpTable() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (count <= 5) {
                ...
                tileComputerStudents[2 * i] = new Tile(gamePanel, x_mt, y1_mt, 16, 16, "Student Computer", "Interact",
                        "", "res/tile/may_tinh_hs.png", 1);
                tileComputerStudents[2 * i + 1] = new Tile(gamePanel, x_mt, y2_mt, 16, 16, "Student Computer",
                        "Interact", "", "res/tile/may_tinh_hs.png", 1);
                x1 += 42;
                x_mt += 42;
            }
            if (count == 5) {
