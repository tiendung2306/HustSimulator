...
public class Thirdfloor_library extends Map {
    ...
    public Tile tileDoorThirdfloor, tileStair02;
    ...
    public void setDefaultValues() {
        ...
        tileStair01 = new Tile(gamePanel, 902, 17, 40, 64, "Cau thang 3 -> 4", "Teleport", "Cau thang len tang 4",
                "res/tile/no_thing.png", 1);
        tileStair02 = new Tile(gamePanel, 962, 17, 37, 64, "Cau thang 3 -> 2", "Teleport", "Cau thang xuong tang 2",
                "res/tile/no_thing.png", 1);
        ...
        tileTable06 = new Tile(gamePanel, 792, 375, 120, 198, "", "Obstacle", "", "res/tile/ban ghe thu vien 3.png",
                (double) 1 / 3);
        tileDoorThirdfloor = new Tile(gamePanel, 658, 33, 108, 73, "Door Thirdfloor", "Teleport", "Vao phong doc",
                "res/tile/no_thing.png", 1);
