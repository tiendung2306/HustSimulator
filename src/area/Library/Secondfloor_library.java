...
public class Secondfloor_library extends Map {
    Tile background;
    Tile wall01, wall02, wall03, wall04, wall05, tileStair03, tileStair04, tileTable01,
            tileTable02, tileTable03, tileTable04, tileTable05, tileTable06;
    public Tile tileStair01, tileStair02;
    GamePanel gamePanel;
    ...
    public void setDefaultValues() {
        ...
        tileStair01 = new Tile(gamePanel, 902, 17, 40, 64, "Cau thang 2 -> 3", "Teleport", "Cau thang len tang 3",
                "res/tile/no_thing.png", 1);
        tileStair02 = new Tile(gamePanel, 962, 17, 37, 64, "Cau thang 2 -> 1", "Teleport", "Cau thang xuong tang 1",
                "res/tile/no_thing.png", 1);
        tileStair03 = new Tile(gamePanel, 354, 210, 3, 51, "Cau thang 2 -> 1", "Teleport", "Cau thang to 1 xuong",
                "res/tile/no_thing.png", 1);
        tileStair04 = new Tile(gamePanel, 629, 210, 3, 51, "Cau thang 2 -> 1", "Teleport", "Cau thang to 2 xuong",
                "res/tile/no_thing.png", 1);
        ...
        tileTable04 = new Tile(gamePanel, 146, 375, 120, 198, "", "Obstacle", "", "res/tile/ban ghe thu vien 2.png",
                (double) 1 / 3);
        tileTable05 = new Tile(gamePanel, 801, 222, 120, 198, "", "Obstacle", "", "res/tile/ban ghe thu vien 3.png",
                (double) 1 / 3);
        tileTable06 = new Tile(gamePanel, 801, 375, 120, 198, "", "Obstacle", "", "res/tile/ban ghe thu vien 3.png",
                (double) 1 / 3);
